      ...
      <div className="flex justify-center gap-6 mb-8">
        <button
          ...
          className={`px-6 py-2 rounded-full font-bold ${
            userType === "user" ? "bg-teal-600 text-white" : "bg-gray-300"
          }`}
        >
          USER
        </button>
        ...
        <button
          ...
          className={`px-6 py-2 rounded-full font-bold ${
            userType === "organizer" ? "bg-teal-600 text-white" : "bg-gray-300"
          }`}
        >
          ORGANIZER
        </button>
      ...
      <div className="w-full  min-h-screen bg-gray-100 pb-20 px-6">
        <div className="max-w-[1400px] mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 ">
          <div className="relative">
            <div className="absolute inset-0 bg-gradient-to-br from-white to-gray-50 rounded-full blur-3xl opacity-60 pointer-events-none"></div>

            <div className="relative z-10 bg-white/80 backdrop-blur-sm p-12 lg:p-16 rounded-full shadow-2xl aspect-square flex flex-col justify-center max-w-[600px] mx-auto">
              ...
              <form onSubmit={handleSubmit} className="space-y-8">
                ...
                <div>
                  <textarea
                    ...
                    className={`w-full pl-6 border-b-2 pb-3 outline-none text-gray-700 placeholder:text-gray-400 text-lg focus:border-gray-500 transition-colors bg-transparent resize-none ${
          ...
          <div className="space-y-10 mt-14">
            <div>
              ...
              <p className="text-gray-500 text-lg leading-relaxed">
                We love making every event unforgettable. Reach out to us and
                let’s start booking your perfect party today!
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-x-16 gap-y-12 pt-6">
              <div className="flex items-start gap-5">
                ...
                <div>
                  <h4 className="font-bold tracking-widest text-black mb-3 text-sm">
                    LOCATION
                  </h4>
