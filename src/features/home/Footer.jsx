    ...
    return (
        <footer className="w-full bg-black text-white pt-16 pb-10">
            ...
            <div className="max-w-7xl mx-auto mb-16 px-4">
               ...
               bg-gradient-to-t from-black via-black/60 to-transparent z-[2]"></div>
                    ...
                    <div className="absolute inset-0 flex flex-col items-center justify-center text-center px-4 z-[3]">
                        ...
                        <button className="text-xl sm:text-[2rem] italic font-serif text-white hover:opacity-150 transition font-bold">
                            let's connect
                        </button>
                    </div>
                </div>
        ...
        ">
                ...
                text-sm sm:text-lg 
                hover:bg-white  
                border border-[#545453]  
                hover:text-black 
                transition-all duration-300
              "
                        >
                            <FiHelpCircle size={20} className="text-[#009689]" />
