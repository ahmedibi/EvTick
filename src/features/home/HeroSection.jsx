    ...
    <div className="relative h-screen w-full overflow-hidden">
      ...
      <div className="absolute bottom-32 right-20 opacity-20">
        <svg width="200" height="60" viewBox="0 0 200 60">
          <path d="M0,30 Q50,0 100,30 T200,30" stroke="white" strokeWidth="2" fill="none" />
          <path d="M0,45 Q50,15 100,45 T200,45" stroke="white" strokeWidth="2" fill="none" />
        </svg>
      </div>
        ...
        <div className="flex items-center justify-between w-full gap-12">
          ...
          <AnimatePresence mode="wait">
            ...
            >
              <motion.p
                ...
                className="text-gray-300 text-lg mb-4 font-light"
              >
                {current.subtitle}
              </motion.p>
              <motion.h1
              ...
              <motion.button
                ...
                whileTap={{ scale: 0.95 }}
                className="group bg-white/10 backdrop-blur-sm rounded text-white px-8 py-4 text-lg font-medium hover:bg-white hover:text-teal-600 transition-all duration-300 flex items-center gap-3 border border-white/20
                "
              >
                View More
                <svg 
                ...
                {slides.map((_, i) => (
                  <button
                    ...
                    className={`h-1 transition-all duration-300 ${
                      i === index ? 'w-16 bg-white' : 'w-8 bg-white/40'
                    }`}
                  />
                ))}
              </div>
          ...
          <div className="relative w-[500px] h-[600px] hidden lg:block">
            ...
            <motion.div
              ...
              transition={{ duration: 0.8 }}
              className="absolute -top-4 -right-4 w-64 h-64 border-2 border-white/30"
            />
            <motion.div
              initial={{ opacity: 0, scale: 0.8 }}
              animate={{ opacity: 1, scale: 1 }}
              transition={{ duration: 0.8, delay: 0.2 }}
              className="absolute -bottom-4 left-12 w-48 h-48 border-2 border-white/30"
            />
